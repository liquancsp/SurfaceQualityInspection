...
{
  std::cout<< "[#Info]In QtVtkWidget cpp!" << std::endl;
  vtkSmartPointer<sqi::vtk::PointPickInteractorStyle> iter_style;
  iter_style = static_cast<sqi::vtk::PointPickInteractorStyle*>(this->GetRenderWindow()->
                                                                GetInteractor()->GetInteractorStyle());
  if(iter_style == NULL)
    return;
  RepresentationType res = static_cast<RepresentationType>(iter_style->GetRepresentation());
  if(res == kPoints)
  {
...
void QtVtkWidget::slot_show_points()
{
  ...
  iter_style = static_cast<sqi::vtk::PointPickInteractorStyle*>(this->GetRenderWindow()->
                                                                GetInteractor()->GetInteractorStyle());
  iter_style->SetPointRepresentation();
}
...
void QtVtkWidget::slot_show_surface()
{
  ...
  iter_style = static_cast<sqi::vtk::PointPickInteractorStyle*>(this->GetRenderWindow()->
                                                                GetInteractor()->GetInteractorStyle());
  iter_style->SetFaceRepresentation();
}
...
void QtVtkWidget::slot_show_wireframe()
{
  ...
  iter_style = static_cast<sqi::vtk::PointPickInteractorStyle*>(this->GetRenderWindow()->
                                                                GetInteractor()->GetInteractorStyle());
  iter_style->SetWireframeRepresentation();
}
...
void QtVtkWidget::slot_show_surface_with_edge()
{
  ...
  iter_style = static_cast<sqi::vtk::PointPickInteractorStyle*>(this->GetRenderWindow()->
                                                                GetInteractor()->GetInteractorStyle());
  iter_style->SetSurfaceWithEdgeRepresentation();
}
